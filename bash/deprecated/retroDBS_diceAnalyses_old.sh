...
function stats_on_data() { # function to obtain results; before, some further processing is needed
	...
	$1/VTAsegmented/${input_pseud}/Warped_vat_right.nii.gz \
	$1/VTAsegmented/${input_pseud}/Warped_vat_left.nii.gz)
	...
	ResampleImage 3 $1/VTAsegmented/${input_pseud}/Warped_vat_left.nii.gz \
	$filename_outputLeft .5x.5x.5 0 4

	filename_outputRight=$4/resampledVTAright.nii
	ResampleImage 3 $1/VTAsegmented/${input_pseud}/Warped_vat_right.nii.gz \
