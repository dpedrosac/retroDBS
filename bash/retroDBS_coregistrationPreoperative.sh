...
# version: 2023-05-28, # created a new version for normalisation of preoperative imaging to MNI space
...
function coregister_PreoperativeResults() # function to coregister the outputs from LeadDBS to MNI space
{
input_pseud=$2
if [[ ! -e $1/preoperative_planningNIFTI/${input_pseud}/preoperative2MNI_0GenericAffine.mat ]]; then
